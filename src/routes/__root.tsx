...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Rosmaninho" },
      ...
      { property: "og:url", content: "https://rosmaninhofotografia.pt" },
      { property: "og:image", content: "https://rosmaninhofotografia.pt/og/cover.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Rosmaninho Fotografia — arquivo lento de imagens por Luísa Rosmaninho" },
    ...
    links: [
      ...
      { rel: "preload", as: "style", href: "https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Work+Sans:wght@300;400;500;600&display=swap" },
