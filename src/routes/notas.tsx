...
export const Route = createFileRoute("/notas")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Notas de Campo — Rosmaninho Fotografia" },
      { property: "og:description", content: "Pensamentos curtos, observações poéticas e reflexões sobre fotografia, luz, cidades e momentos." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://rosmaninhofotografia.pt/notas" },
      { property: "og:image", content: "https://rosmaninhofotografia.pt/og/cover.jpg" },
      { property: "og:image:alt", content: "Notas de Campo — Rosmaninho Fotografia" },
      { property: "og:locale", content: "pt_PT" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Notas de Campo — Rosmaninho Fotografia" },
      { name: "twitter:description", content: "Pensamentos curtos, observações poéticas e reflexões sobre fotografia, luz, cidades e momentos." },
      { name: "twitter:image", content: "https://rosmaninhofotografia.pt/og/cover.jpg" },
    ],
